...
class infileOtherPOSSig extends infile
{
    boolean sentenceEnd;
    int sentCount;
	
    infileOtherPOSSig(int size)
    {
...
class OtherPOSSig
{
    ...
    public static void main(String v[]) throws IOException
    {
        ...
        JMontyTagger j = new JMontyTagger();
        	   	   FileWriter data = new FileWriter("graphs/OtherPOSsig.txt");
	   FileWriter plot = new FileWriter("graphs/OtherPOSSig.gnu");
		 FileWriter record=new FileWriter("graphs/OtherPOSSigRec.txt",true);



        infileOtherPOSSig input=new infileOtherPOSSig(v.length);
		...
		int wordCount=input.getWordCount(SigSentence)+1;
...
plot.write("set terminal jpeg\n");
	plot.write("set output \"graphs/OtherPOSSig.jpg\"\n");
	plot.write("set title \"Other POS significant sentence approach\"\n");
	plot.write("set xlabel \"Threshold\"\n");
	plot.write("set ylabel \"Accuracy\"\n");
	plot.write("plot  \'graphs/OtherPOSSig.txt\' using 1:2 with lines title \'Other POS significant sentence/\' lw 3\n");
