...
class infileOtherPOSFirst extends infile
{

    infileOtherPOSFirst(int size)
    {
...
class OtherPOSFirst
{
    ...
    public static void main(String v[]) throws IOException
    {
		...
		JMontyTagger j = new JMontyTagger();
    	   	   FileWriter data = new FileWriter("graphs/OtherPOSFirst.txt");
	   FileWriter plot = new FileWriter("graphs/OtherPOSFirst.gnu");
		   FileWriter record=new FileWriter("graphs/OtherPOSFirstRec.txt",true);

        infileOtherPOSFirst input=new infileOtherPOSFirst(v.length);
...
plot.write("set terminal jpeg\n");
	plot.write("set output \"graphs/OtherPOSFirst.jpg\"\n");
	plot.write("set title \"Other POS first sentence approach\"\n");
	plot.write("set xlabel \"Threshold\"\n");
	plot.write("set ylabel \"Accuracy\"\n");
	plot.write("plot  \'graphs/OtherPOSFirst.txt\' using 1:2 with lines title \'Other POS First sentence/\' lw 3\n");
